...
class ProductController extends Controller
{
    ...
    public function allow_comment(Request $request){
     ...
     public function reply_comment(Request $request){
        ...
        $comment->rating_id = $data['rating_id'];
     ...
     public function list_comment(){
        $all_rating = DB::table('tbl_product')
        ->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')
        //join brand table
        ->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')
        //end join brand table
        //join rating table
        ->join('tbl_rating','tbl_product.product_id','=','tbl_rating.product_id')
        //end join rating table
    ...
    public function send_comment(Request $request){
        ...
        // insert rating and get rating id
    ...
    public function load_comment(Request $request){
        ...
        foreach ($comment as $key => $comm) {
            ...
            <div class="row style_comment">
                                    ...
                                    $output.='
                                    <div class="row style_comment" style="margin-left: 40px">
                                       
                                        <div class="col-md-2">
                                        
                                            <img width="60%" src="'.url('public/frontend/images/TekTop.jpg').'" class="img img-responsive img-thumbnail">
                                        </div>
    ...
    public function save_product(Request $request){
    	...
    	// $data = array();
         $data = $request->validate(
            [
                ...
                'product_desc.required' => 'Mô tả dài 255 ký tự',
                'product_content.required'  => 'Nội dung dài 225 ký tự',
            ]
        ...
        $data['product_slug'] = \Str::slug($request->product_name).'-'.\Carbon\Carbon::now()->timestamp;
    ...
    public function unactive_product($product_id){
      ...
      Toastr::success('Không kích hoạt sản phẩm thành công','Success');
    ...
    public function active_product($product_id){
       ...
       Toastr::success('Kích hoạt sản phẩm thành công','Success');
        return Redirect::to('all-product');
    }
    ...
    public function update_product(Request $request, $product_id){
        ...
        Toastr::success('Sửa sản phẩm thành công','Success');
        return Redirect::to('all-product');
    }
    ...
    public function delete_product($product_id){
        ...
        Toastr::success('Xoá sản phẩm thành công','Success');
        return Redirect::to('all-product');
    }
     //End Admin Page
    public function details_product(Request $request, $product_slug){
      ...
      $rating = Rating::where('product_id',$product_id)->avg('rating');
        ...
        $rating_id = Rating::where('product_id',$product_id)->pluck('rating_id');

        


        return view('pages.sanpham.show_details')->with('rating_id',$rating_id)->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('category_post',$category_post)->with('gallery',$gallery)->with('product_cate',$product_cate)->with('cate_slug',$cate_slug)->with('min_price',$min_price)->with('max_price',$max_price)->with('rating',$rating)->with('edit_introductions',$edit_introductions);
