...
class OrderController extends Controller
{
    ...
    public function update_order_qty(Request $request){
        ...
        $free_ship = $details->product_freeship;
    ...
    public function print_order_convert($checkout_code){
        ...
        <h1><center>TekTop - Thiết bị công nghệ</center></h1>
        ...
        <table class="table-styling">
            <thead>
                <tr>
                    ...
                    <th width="215px">Số điện thoại</th>
                    <th>Email</th>
                </tr>
            </thead>
            <tbody>';
        ...
        <table class="table-styling">
            ...
            $total = 0;
                ...
                foreach ($order_details_product as $key => $product) {
                    ...
                    $total += $subtotal;
                    if($product->product->coupon != 'No'){
                        $product->product->product_coupon;
                    }else{
                ...
                $output.='
                    <tr>
                        ...
                        <td>'.number_format($product->product_freeship,0,',','.').' VNĐ'.'</td>
                ...
                <td colspan = "2">
                    ...
                    <p>Phí vận chuyển:'. number_format($product->product_freeship,0,',','.').' VNĐ'.'</p>
                    <p>Thanh toán:'. number_format($total - $product->product_freeship,0,',','.').' VNĐ'.'</p>
                </tr>';
    ...
    public function history(Request $request){
     ...
     //category_post
        ...
        $getorder = Order::where('customer_id',Session::get('customer_id'))->orderby('order_date','DESC')->paginate(10);
        return view('pages.history.history')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title', $meta_title)->with('url_canonical', $url_canonical)->with('slider',$slider)->with('category_post',$category_post)->with('getorder',$getorder)->with('edit_introductions',$edit_introductions);
        }        
    }
