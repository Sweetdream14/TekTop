            ...
            foreach($gallery as $key => $gal) {
              ...
              $output.='
                  ...
                  <tr>
                    ...
                    <input type="file" class="file_image" style="width:40%;margin-top: 5px;" data-gal_id="'.$gal->gallery_id.'" id= "file-'.$gal->gallery_id.'" name="file" accept="image/*" >
                    </td>
             ...
             $output.='
                  <tr>
                    <td colspan = "4">Sản phẩm này chưa có trong thư viện ảnh</td>
                  </tr> 
              ';
        }
         $output.='
