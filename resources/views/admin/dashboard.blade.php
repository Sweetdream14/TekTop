...
<div class="row">
		...
		<form autocomplete="off">
			...
			<div class="col-md-2" style="width: 300px;">
				...
				<input type="button" id="btn-dashboard-filter" class="btn btn-primary btn-sm" value="Lọc kết quả" style="margin-top: 10px;"></p>
			...
			<div class="col-md-2">
				<p>
					Lọc theo: 
					<select class="dashboard-filter form-control" style="width: 300px;">
						<option>-- Chọn --</option>
