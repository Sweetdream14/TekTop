		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: #ff66cc;padding: 15px">
				...
				<div class="col-md-12">
					...
					<p>Phí ship hàng: <strong style="text-transform: uppercase;color:#fff">{{$shipping_array['free_ship']}}</strong></p>
					...
					<table class="table table-striped" style="border:1px">
						...
						<tbody>
							...
							<tr>
								...
								<td style="width: 130px;text-align: center">{{$cart['product_qty']}}</td>
				...
				<p style="color:#fff;text-align: center;font-size: 15px;">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://tektop.uk">Shop</a>, hoặc liên hệ qua số hotline : 19005689.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
