            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-introduction')}}">Giới thiệu cửa hàng</a></li>
                        <li><a href="{{URL::to('/all-introduction')}}">Liệt kê giới thiệu</a></li>    
                    </ul>
                </li>
                   <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-category-post')}}">Thêm tin tức</a></li>
                        <li><a href="{{URL::to('/all-category-post')}}">Liệt kê tin tức</a></li>
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/video')}}">Thêm video
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-information')}}">Thêm liên hệ</a></li>
                        <li><a href="{{URL::to('/all-information')}}">Liệt kê liên hệ</a></li>
                    ...
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Bài viết chân trang</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-post-footer')}}">Thêm bài viết chân trang</a></li>
                        <li><a href="{{URL::to('/all-post-footer')}}">Liệt kê bài viết chân trang</a></li>
...
<script type="text/javascript">
    ...
    $('.add-doitac').click(function(){
        ...
        form_data.append('name_doitac',name);
        form_data.append('link_doitac',link);
...
<script type="text/javascript">
    ...
    $('.add-nut').click(function(){
        ...
        var name = $('#name_icons').val();
        var link = $('#link_icons').val();
        var image = $('#image_nut')[0].files[0];
        // console.log(image);
        var form_data = new FormData();

            form_data.append('file',image);
            form_data.append('name_icons',name);
            form_data.append('link_icons',link);
    ...
    var colorDanger = "#FF1744";
        Morris.Donut({
          ...
          data: [
            ...
            {label:"Đon hang", value:<?php echo $app_order ?>},
     ...
     $('.reply_comment').on('submit',function(e){
        ...
        // alert(rating_id);
          $.ajax({
                ...
                data:{comment:comment,comment_id:comment_id,comment_product_id:comment_product_id,rating_id:rating_id},
                success:function(data){
                    $('.reply_comment_'+comment_id).val('');
                   $('#notify_comment').html('<span class="text text-alert">Trả lời bình luận thành công</span>');
...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     $(document).on('click','.btn-delete-video',function(){
            ...
            if(confirm('Bạn muốn xoá video này không ?')){                    
            $.ajax({
                ...
                success:function(data){
                    load_video();
                    $('#notify').html('<span class="text text-success">Xoá video thành công</span>');
                }
            });
        }
    });
    ...
    $(document).on('blur','.video_edit',function(){
            ...
            if(video_type == 'video_title'){
             ...
             $.ajax({
                ...
                success:function(data){
                    load_video();
                    $('#notify').html('<span class="text text-success">Sửa video thành công</span>');
                }
            });
...
<script type="text/javascript">
        ...
        $('#file').change(function(){
            ...
            if(files.length>5){
                error+='<p style="margin-top: 6px;">Bạn chọn tối đa chỉ được 5 ảnh</p>';
            }else if(files.length==''){
                error+='<p style="margin-top: 6px;">Bạn không được bỏ trống ảnh</p>';
            }else if(files.size > 2000000){
                error+='<p style="margin-top: 6px;">File ảnh không được lớn hơn 2MB</p>';
            }
        ...
        $(document).on('blur','.edit_gal_name',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    load_gallery();
                    $('#error_gallery').html('<center style="margin-top: 10px;"><span class="text-danger">Sửa tên hình ảnh thành công</span></center>');
                }
            });
        });
        ...
        $(document).on('click','.delete-gallery',function(){
            ...
            if(confirm('Bạn muốn xóa hình ảnh này không?')){
                $.ajax({
                    ...
                    success:function(data){
                        load_gallery();
                        $('#error_gallery').html('<center style="margin-top: 10px;"><span class="text-danger">Xóa hình ảnh thành công</span></center>');
                    }
                });
            }
        });
        ...
        $(document).on('change','.file_image',function(){
            ...
            form_data.append("gal_id",gal_id);
                ...
                $.ajax({
                    ...
                    success:function(data){
                        load_gallery();
                        $('#error_gallery').html('<center style="margin-top: 10px;"><span class="text-danger">Cập nhật hình ảnh thành công</span></center>');
                    }
                });
