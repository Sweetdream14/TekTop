...
@section('content')
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="table-responsive cart_info" style="width: 848px;">
				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_description" style="width: 125px;">
								<h4><a href=""></a></h4>
								<p>{{$cart['product_name']}}</p>
							</td>
							<td class="cart_number" style="width: 120px;">	
								<h4><a href=""></a></h4>
						...
						@endforeach
						<tr>
							<td colspan="5"><input type="submit" value="Cập nhật giỏ hàng" name="update_qty" class="check_out btn btn-default btn-sm">
							...
							<td colspan="2">
							Tổng tiền :<span>{{number_format($total,0,',','.')}}đ</span><br>
									...
									@foreach(Session::get('coupon') as $key => $cou)
										@if($cou['coupon_condition']==1)
											...
											<br>
												...
												echo 'Tổng giảm: '.number_format($total_coupon,0,',','.').' VNĐ';
												@endphp
											<br>
											Tổng tiền: {{number_format($total-$total_coupon,0,',','.')}} VNĐ<br>
					...
					<tr><td>
							...
							<form method="POST" action="{{url('/check-coupon')}}">
								@csrf
									<input type="text" class="form-control" name="coupon" placeholder="Nhập mã giảm giá" style="width: 140px;"><br>
